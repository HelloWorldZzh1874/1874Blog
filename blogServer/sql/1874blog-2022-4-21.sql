...
CREATE TABLE `con_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1818 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `con_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5570 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `con_role_resource` VALUES (5567, 2, 227);
INSERT INTO `con_role_resource` VALUES (5568, 2, 234);
INSERT INTO `con_role_resource` VALUES (5569, 2, 235);
...
-- ----------------------------
INSERT INTO `tb_comment` VALUES (306, 15, 76, 'hello<img src= \'https://1874centos-1304996288.cos.ap-chongqing.myqcloud.com/emoji/miaoa.PNG\' width=\'22\' height=\'20\' style=\'padding: 0 1px\'/>', '2022-04-21 20:31:19', NULL, NULL, 0);
...
INSERT INTO `tb_operation_log` VALUES (371, '定时任务模块', '修改', '/quartz/pauseJob/5', 'com.zzh.controller.QuartzController.pauseQuartz', '暂停一个任务', '[5]', 'PUT', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-11 13:04:42');
INSERT INTO `tb_operation_log` VALUES (372, '定时任务模块', '修改', '/quartz/resumeJob/5', 'com.zzh.controller.QuartzController.resumeQuartz', '恢复一个任务', '[5]', 'PUT', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-11 13:05:28');
INSERT INTO `tb_operation_log` VALUES (373, '定时任务模块', '修改', '/quartz/pauseJob/5', 'com.zzh.controller.QuartzController.pauseQuartz', '暂停一个任务', '[5]', 'PUT', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-11 13:06:17');
INSERT INTO `tb_operation_log` VALUES (374, '定时任务模块', '修改', '/quartz/resumeJob/5', 'com.zzh.controller.QuartzController.resumeQuartz', '恢复一个任务', '[5]', 'PUT', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-11 13:08:10');
INSERT INTO `tb_operation_log` VALUES (375, '定时任务模块', '修改', '/quartz/pauseJob/5', 'com.zzh.controller.QuartzController.pauseQuartz', '暂停一个任务', '[5]', 'PUT', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-11 13:08:18');
INSERT INTO `tb_operation_log` VALUES (376, '定时任务模块', '保存', '/quartz/add', 'com.zzh.controller.QuartzController.addSysQuartz', '添加一个定时任务', '[{\"cronExpression\":\"0/5 * * * * ?\",\"jobClassname\":\"TestJob\",\"jobGroup\":\"SystemJob\",\"jobName\":\"test\"}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-11 14:01:51');
INSERT INTO `tb_operation_log` VALUES (377, '定时任务模块', '修改', '/quartz/pauseJob/6', 'com.zzh.controller.QuartzController.pauseQuartz', '暂停一个任务', '[6]', 'PUT', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-11 14:02:03');
INSERT INTO `tb_operation_log` VALUES (378, '定时任务模块', '删除', '/quartz/deleteJob', 'com.zzh.controller.QuartzController.deleteQuartz', '删除一个任务', '[7]', 'DELETE', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-12 11:22:16');
INSERT INTO `tb_operation_log` VALUES (379, '定时任务模块', '删除', '/quartz/deleteJob', 'com.zzh.controller.QuartzController.deleteQuartz', '删除一个任务', '[5]', 'DELETE', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-12 11:23:35');
INSERT INTO `tb_operation_log` VALUES (380, '定时任务模块', '保存', '/quartz/add', 'com.zzh.controller.QuartzController.addSysQuartz', '添加一个定时任务', '[{\"cronExpression\":\"0/5 * * * * ?\",\"jobClassname\":\"TestJob\",\"jobGroup\":\"commonJob\",\"jobName\":\"test\"}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-12 11:32:21');
INSERT INTO `tb_operation_log` VALUES (381, '定时任务模块', '修改', '/quartz/pauseJob/8', 'com.zzh.controller.QuartzController.pauseQuartz', '暂停一个任务', '[8]', 'PUT', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-12 11:32:28');
INSERT INTO `tb_operation_log` VALUES (382, '文章模块', '修改', '/article/admin/deleteOrRecArticle', 'com.zzh.controller.ArticleController.deleteOrRecArticle', '文章逻辑删除或恢复', '[{\"idList\":[72],\"isDelete\":1}]', 'PUT', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-17 15:34:50');
INSERT INTO `tb_operation_log` VALUES (383, '文章模块', '删除', '/article/admin/deleteArticles', 'com.zzh.controller.ArticleController.deleteArticles', '文章物理删除', '[[72]]', 'DELETE', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-17 15:35:05');
INSERT INTO `tb_operation_log` VALUES (384, '分类模块', '删除', '/category/admin/deleteCategory', 'com.zzh.controller.CategoryController.deleteCategory', '删除分类', '[[21]]', 'DELETE', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-17 15:35:09');
INSERT INTO `tb_operation_log` VALUES (385, '标签模块', '删除', '/tag/admin/deleteTag', 'com.zzh.controller.TagController.deleteTag', '删除标签', '[[25,24]]', 'DELETE', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-17 15:35:14');
INSERT INTO `tb_operation_log` VALUES (386, '分类模块', '新增或修改', '/category/admin/saveOrUpdateCategory', 'com.zzh.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"测试\"}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-17 15:36:02');
INSERT INTO `tb_operation_log` VALUES (387, '标签模块', '新增或修改', '/tag/admin/saveOrUpdateTag', 'com.zzh.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"beta\"}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-17 15:36:13');
INSERT INTO `tb_operation_log` VALUES (388, '用户模块', '删除', '/user/deleteAccount', 'com.zzh.controller.UserController.deleteAccount', '删除账号', '[12]', 'DELETE', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-18 16:57:19');
INSERT INTO `tb_operation_log` VALUES (389, '定时任务模块', '删除', '/quartz/deleteJob', 'com.zzh.controller.QuartzController.deleteQuartz', '删除一个任务', '[8]', 'DELETE', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-19 23:19:45');
INSERT INTO `tb_operation_log` VALUES (390, '定时任务模块', '保存', '/quartz/add', 'com.zzh.controller.QuartzController.addSysQuartz', '添加一个定时任务', '[{\"cronExpression\":\"0 30 0 * * ?\",\"jobClassname\":\"ClearViewIpSet\",\"jobGroup\":\"SystemJob\",\"jobName\":\"清除每日访问ip\"}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-19 23:22:40');
INSERT INTO `tb_operation_log` VALUES (391, '定时任务模块', '保存', '/quartz/add', 'com.zzh.controller.QuartzController.addSysQuartz', '添加一个定时任务', '[{\"cronExpression\":\"0 10 0 * * ?\",\"jobClassname\":\"SaveUniqueView\",\"jobGroup\":\"SystemJob\",\"jobName\":\"保存每日访问ip\"}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-19 23:23:09');
INSERT INTO `tb_operation_log` VALUES (392, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"id\":231,\"isAnonymous\":1,\"isDisable\":0,\"requestMethod\":\"GET\",\"resourceName\":\"查看分类列表\",\"url\":\"/category/categoryList\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-20 20:29:55');
INSERT INTO `tb_operation_log` VALUES (393, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"id\":232,\"isAnonymous\":1,\"isDisable\":0,\"requestMethod\":\"GET\",\"resourceName\":\"查看分类下对应的文章\",\"url\":\"/article/category/*\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-20 20:46:55');
INSERT INTO `tb_operation_log` VALUES (394, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"id\":240,\"isAnonymous\":1,\"isDisable\":0,\"requestMethod\":\"GET\",\"resourceName\":\"查看标签列表\",\"url\":\"/getList\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-20 20:59:28');
INSERT INTO `tb_operation_log` VALUES (395, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"id\":240,\"isAnonymous\":1,\"isDisable\":0,\"requestMethod\":\"GET\",\"resourceName\":\"查看标签列表\",\"url\":\"/tag/getList\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-20 20:59:49');
INSERT INTO `tb_operation_log` VALUES (396, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"id\":241,\"isAnonymous\":1,\"isDisable\":0,\"requestMethod\":\"GET\",\"resourceName\":\"查看分类下对应的文章\",\"url\":\"/article/tag/*\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-20 21:03:02');
INSERT INTO `tb_operation_log` VALUES (397, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"id\":237,\"isAnonymous\":1,\"isDisable\":0,\"requestMethod\":\"GET\",\"resourceName\":\"查看友链列表\",\"url\":\"/friend-link/getList\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-21 11:56:22');
INSERT INTO `tb_operation_log` VALUES (398, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"id\":236,\"isAnonymous\":1,\"isDisable\":0,\"requestMethod\":\"GET\",\"resourceName\":\"查询评论下的回复\",\"url\":\"/comment/replies/*\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-21 15:02:45');
INSERT INTO `tb_operation_log` VALUES (399, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"id\":235,\"isAnonymous\":0,\"isDisable\":0,\"requestMethod\":\"POST\",\"resourceName\":\"评论点赞\",\"url\":\"/comment/like\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-21 15:14:10');
INSERT INTO `tb_operation_log` VALUES (400, '角色模块', '新增或修改', '/role/admin/saveOrUpdateRole', 'com.zzh.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":2,\"resourceIdList\":[235],\"roleLabel\":\"用户\",\"roleName\":\"ROLE_USER\",\"type\":2}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-21 15:14:41');
INSERT INTO `tb_operation_log` VALUES (401, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"id\":234,\"isAnonymous\":0,\"isDisable\":0,\"requestMethod\":\"POST\",\"resourceName\":\"添加评论或回复\",\"url\":\"/comment/addComment\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-21 17:10:06');
INSERT INTO `tb_operation_log` VALUES (402, '角色模块', '新增或修改', '/role/admin/saveOrUpdateRole', 'com.zzh.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":2,\"resourceIdList\":[234,235],\"roleLabel\":\"用户\",\"roleName\":\"ROLE_USER\",\"type\":2}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-21 17:10:19');
INSERT INTO `tb_operation_log` VALUES (403, '角色模块', '新增或修改', '/role/admin/saveOrUpdateRole', 'com.zzh.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":2,\"resourceIdList\":[227,234,235],\"roleLabel\":\"用户\",\"roleName\":\"ROLE_USER\",\"type\":2}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-21 20:11:57');
...
INSERT INTO `tb_role` VALUES (2, 'ROLE_USER', '用户', '2022-03-09 21:27:27', '2022-04-21 20:11:57', 0);
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$nUzL5ZZ6h808EWKeDr1Jg.qGuRPAkfCyaAjv1/9lChSsb6SK5A6wm', 1, 1, '2022-04-21 20:11:17', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
INSERT INTO `tb_user` VALUES (15, 16, '3376753860@qq.com', '$2a$10$aLhuDUnucaatsZ0UIetHsOfYgnzerJWnxpDyZXz8w0fQAuqC4a91i', 1, 1, '2022-04-21 20:31:12', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
...
INSERT INTO `tb_user_info` VALUES (16, '3376753860@qq.com', '用户2f13b624-0cb7-4fb6-ba2b-162306b19881', 'https://1874centos-1304996288.cos.ap-chongqing.myqcloud.com/AvatarImg/catAvatar.webp', NULL, NULL, '2022-04-19 20:34:27', NULL);
