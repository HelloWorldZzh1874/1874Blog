...
CREATE TABLE `con_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5299 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_resource` VALUES (219, '修改用户禁用状态', '/user/admin/lockState/*', 'PUT', 172, '2022-03-09 21:27:51', '2022-03-09 21:27:47', 0, 0);
...
INSERT INTO `tb_resource` VALUES (285, '退出', '/logout', 'POST', 168, '2022-03-12 22:03:07', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (286, '退出', '/user/logout', 'POST', 168, '2022-03-12 22:03:07', NULL, 0, 1);
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$XqjK7hO9jqc7YpBqBsySK.79VaqEwbdGsmkTJmCgGoMz0qrj.xz9a', 1, 1, '2022-03-15 22:53:48', '192.168.85.1', '本地局域网', 'Chrome 9', 'Windows 10');
...
-- ----------------------------
INSERT INTO `tb_user_info` VALUES (12, '374368081@qq.com', 'admin', 'https://1874centos-1304996288.cos.ap-chongqing.myqcloud.com/AvatarImg/1429690935532331009.jpg', 'test', 'test', '2022-03-05 17:34:53', NULL);
