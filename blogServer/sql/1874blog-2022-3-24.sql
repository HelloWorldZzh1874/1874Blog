...
CREATE TABLE `con_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1639 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `con_role_menu` VALUES (1631, 1, 1);
INSERT INTO `con_role_menu` VALUES (1632, 1, 2);
INSERT INTO `con_role_menu` VALUES (1633, 1, 6);
INSERT INTO `con_role_menu` VALUES (1634, 1, 7);
INSERT INTO `con_role_menu` VALUES (1635, 1, 8);
INSERT INTO `con_role_menu` VALUES (1636, 1, 9);
INSERT INTO `con_role_menu` VALUES (1637, 1, 10);
INSERT INTO `con_role_menu` VALUES (1638, 1, 5);
...
CREATE TABLE `con_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5375 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_resource` VALUES (287, '删除角色', '/role/admin/delete', 'DELETE', NULL, NULL, NULL, 0, 0);
...
-- Records of tb_role
-- ----------------------------
INSERT INTO `tb_role` VALUES (1, 'ROLE_ADMIN', '管理员', '2022-03-09 21:27:27', '2022-03-23 10:22:44', 0);
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$XqjK7hO9jqc7YpBqBsySK.79VaqEwbdGsmkTJmCgGoMz0qrj.xz9a', 1, 1, '2022-03-24 20:21:21', '192.168.85.1', '本地局域网', 'Chrome 9', 'Windows 10');
INSERT INTO `tb_user` VALUES (12, 13, 'test', '$2a$10$c8eNs4ohs.w/kwskHCZsAeoCJfBSTOUpARVNml9nSqLBxpiHSpft2', 0, 1, '2022-03-24 20:22:07', '192.168.85.1', '本地局域网', 'Chrome 9', 'Windows 10');
