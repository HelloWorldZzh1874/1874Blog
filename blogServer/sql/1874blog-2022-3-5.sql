...
CREATE TABLE `con_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1612 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `con_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5275 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_resource` VALUES (178, '查看博客信息', '/', 'GET', 166, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (179, '查看关于我信息', '/about', 'GET', 166, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
...
INSERT INTO `tb_resource` VALUES (182, '查看后台文章', '/admin/getArticles', 'GET', 168, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (183, '添加或修改文章', '/admin/article/saveAndUpdateArticle', 'POST', 168, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (184, '恢复或删除文章', '/admin/article/deleteOrRecArticle', 'PUT', 168, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (185, '物理删除文章', '/admin/article/deleteArticles', 'DELETE', 168, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (186, '上传文章图片', '/admin/article/uploadImg', 'POST', 168, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (187, '查看文章选项', '/admin/article/options', 'GET', 168, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (188, '修改文章置顶', '/admin/article/top/*', 'PUT', 168, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (189, '根据id查看后台文章', '/admin/article/selectArticlesById/*', 'GET', 168, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (190, '查看后台分类列表', '/admin/categories', 'GET', 165, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (191, '添加或修改分类', '/admin/categories/saveOrUpdateCategory', 'POST', 165, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (192, '删除分类', '/admin/categories/deleteCategory', 'DELETE', 165, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (193, '查询后台评论', '/admin/comment/getBackComments', 'GET', 176, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (194, '删除或恢复评论', '/admin/comment/updateCommentsStatus', 'PUT', 176, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (195, '物理删除评论', '/admin/comment/deleteComments', 'DELETE', 176, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (196, '查看后台友链列表', '/admin/link/getLinks', 'GET', 167, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (197, '保存或修改友链', '/admin/links', 'POST', 167, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (198, '删除友链', '/admin/deleteLinks', 'DELETE', 167, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (199, '查看菜单列表', '/admin/menu/getMenu', 'POST', 174, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (200, '查看后台留言列表', '/admin/message/getBackMessages', 'GET', 173, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (201, '删除留言', '/admin/message/deleteMessages', 'DELETE', 173, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
...
INSERT INTO `tb_resource` VALUES (207, '新增或修改资源', '/admin/resources/addOrUpdate', 'POST', 177, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (208, '删除资源', '/admin/resources/delete', 'DELETE', 177, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
...
INSERT INTO `tb_resource` VALUES (210, '保存或更新角色', '/admin/saveOrUpdateRole', 'POST', 175, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
...
INSERT INTO `tb_resource` VALUES (213, '查询角色列表', '/admin/role/roles', 'GET', 175, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (214, '查看后台标签列表', '/admin/tags/selectTags', 'GET', 170, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (215, '添加或修改标签', '/admin/tags/saveOrUpdateTag', 'POST', 170, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (216, '删除标签', '/admin/tags/deleteTag', 'DELETE', 170, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (217, '查看用户菜单', '/admin/menu/getMenu', 'GET', 174, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (218, '查看后台用户列表', '/admin/user/users', 'GET', 172, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (219, '修改用户禁用状态', '/admin/userInfo/changeEnable/*', 'PUT', 171, '2021-03-20 22:56:20', '2021-08-19 00:11:35', 0, 0);
...
INSERT INTO `tb_resource` VALUES (223, '查询用户角色选项', '/admin/role/roleList', 'GET', 175, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (224, '修改用户角色', '/admin/userInfo/updateRole', 'PUT', 171, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
...
INSERT INTO `tb_resource` VALUES (244, '发送邮箱验证码', '/users/code', 'GET', 172, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
...
INSERT INTO `tb_resource` VALUES (250, '上传文章封面', '/admin/article/uploadCover', 'POST', 168, '2021-07-30 23:23:35', '2021-07-30 23:23:36', 0, 0);
INSERT INTO `tb_resource` VALUES (252, '查看后台菜单', '/admin/menus', 'GET', 174, '2021-08-01 14:22:14', '2021-08-01 14:22:16', 0, 0);
INSERT INTO `tb_resource` VALUES (253, '更新或添加菜单数据', '/admin/updateOrSaveMenu', 'POST', 174, '2021-08-01 17:16:04', '2021-08-01 17:16:06', 0, 0);
INSERT INTO `tb_resource` VALUES (254, '删除菜单数据', '/admin/deleteMenu', 'DELETE', 174, '2021-08-01 17:37:13', '2021-08-01 17:37:14', 0, 0);
INSERT INTO `tb_resource` VALUES (262, '音乐模块', NULL, NULL, NULL, '2021-08-05 23:10:44', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (263, '获取歌单音乐id列表', '/musicList', 'GET', 262, '2021-08-05 23:11:49', '2021-08-05 23:11:55', 0, 1);
INSERT INTO `tb_resource` VALUES (264, '查找指定音乐url', '/music/musicUrl', 'GET', 262, '2021-08-06 15:32:41', '2021-08-06 17:21:36', 0, 1);
INSERT INTO `tb_resource` VALUES (265, '获取歌曲歌词', '/music/lyric', 'GET', 262, '2021-08-06 17:21:58', '2021-08-06 17:22:00', 0, 1);
INSERT INTO `tb_resource` VALUES (266, '获取歌曲详情', '/music/getMusicInfo', 'GET', 262, '2021-08-06 23:20:46', '2021-08-06 23:20:48', 0, 1);
INSERT INTO `tb_resource` VALUES (267, '模糊查询', '/music/getMusicLike', 'GET', 262, '2021-08-07 13:31:35', '2021-08-07 13:31:36', 0, 1);
INSERT INTO `tb_resource` VALUES (268, '查询用户文章', '/articles/getUserArticle', 'GET', 168, '2021-08-12 22:07:56', '2021-08-12 22:07:58', 0, 1);
INSERT INTO `tb_resource` VALUES (269, '查询后台歌曲', '/admin/music/getMusicLists', 'GET', 262, '2021-08-18 14:27:30', '2021-08-18 17:29:48', 0, 0);
INSERT INTO `tb_resource` VALUES (271, '添加歌曲', '/admin/music/add', 'POST', 262, '2021-08-18 22:04:16', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (272, '更新歌曲文件', '/admin/music/updateFile/*', 'POST', 262, '2021-08-18 22:05:40', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (273, '更新歌曲信息', '/admin/music/updateMusicInfo', 'POST', 262, '2021-08-18 22:05:52', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (274, '删除歌曲', '/admin/music/delete', 'DELETE', 262, '2021-08-18 22:06:09', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (275, '后台查询歌手', '/admin/singer/findAll', 'GET', 262, '2021-08-18 22:19:30', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (276, '更新歌曲图片', '/admin/music/updateImg', 'POST', 262, '2021-08-19 00:38:52', '2021-08-19 14:21:22', 0, 0);
INSERT INTO `tb_resource` VALUES (277, '查询后台歌手', '/admin/singer/list', 'GET', 262, '2021-08-19 13:15:52', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (278, '修改或保存歌手信息', '/admin/singer/saveOrUpdateSinger', 'POST', 262, '2021-08-19 13:16:47', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (279, '删除歌手信息', '/admin/singer/delete', 'DELETE', 262, '2021-08-19 13:17:05', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (280, '更新歌手图片', '/admin/singer/updateImg', 'POST', 262, '2021-08-19 14:15:35', '2021-08-19 14:21:18', 0, 0);
INSERT INTO `tb_resource` VALUES (281, '根据歌手id查找歌曲', '/admin/music/listBySinger', 'GET', 262, '2021-08-19 16:57:09', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (283, '普通登录', '/login', 'POST', 172, '2022-03-05 00:05:10', NULL, 0, 1);
...
-- Records of tb_role
-- ----------------------------
INSERT INTO `tb_role` VALUES (1, 'ROLE_ADMIN', '管理员', '2021-07-30 21:54:29', '2021-08-12 15:14:28', 0);
INSERT INTO `tb_role` VALUES (2, 'ROLE_USER', '用户', '2021-07-13 21:54:31', '2021-08-19 21:22:43', 0);
INSERT INTO `tb_role` VALUES (4, 'ROLE_ROOT', '超级管理员', '2021-07-31 13:51:40', '2021-08-19 16:57:22', 0);
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$XqjK7hO9jqc7YpBqBsySK.79VaqEwbdGsmkTJmCgGoMz0qrj.xz9a', 1, 1, '2022-03-05 17:56:27', '192.168.85.1', '本地局域网', 'Unknown', 'Unknown');
