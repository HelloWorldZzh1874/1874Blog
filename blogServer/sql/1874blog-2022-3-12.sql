...
-- ----------------------------
INSERT INTO `con_article_tag` VALUES (273, 72, 24);
INSERT INTO `con_article_tag` VALUES (274, 72, 25);
...
CREATE TABLE `con_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5290 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `tb_article` VALUES (72, 11, 21, 'aaa', 'test', 'test', '2022-03-10 23:08:39', NULL, 0, 0, 0);
...
-- ----------------------------
INSERT INTO `tb_category` VALUES (21, 'test', '2022-03-10 22:57:32');
...
-- Records of tb_tag
-- ----------------------------
INSERT INTO `tb_tag` VALUES (24, 'test1', '2022-03-10 22:56:41');
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$XqjK7hO9jqc7YpBqBsySK.79VaqEwbdGsmkTJmCgGoMz0qrj.xz9a', 1, 1, '2022-03-12 23:34:29', '192.168.85.1', '本地局域网', 'Chrome 9', 'Windows 10');
