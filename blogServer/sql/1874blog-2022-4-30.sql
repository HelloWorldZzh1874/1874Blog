...
CREATE TABLE `con_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5605 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `con_role_resource` VALUES (5626, 2, 227);
INSERT INTO `con_role_resource` VALUES (5627, 2, 243);
INSERT INTO `con_role_resource` VALUES (5628, 2, 245);
INSERT INTO `con_role_resource` VALUES (5629, 2, 234);
INSERT INTO `con_role_resource` VALUES (5630, 2, 235);
INSERT INTO `con_role_resource` VALUES (5631, 2, 310);
INSERT INTO `con_role_resource` VALUES (5632, 2, 311);
INSERT INTO `con_role_resource` VALUES (5633, 2, 312);
INSERT INTO `con_role_resource` VALUES (5634, 2, 313);
INSERT INTO `con_role_resource` VALUES (5635, 2, 307);
INSERT INTO `con_role_resource` VALUES (5636, 2, 308);
INSERT INTO `con_role_resource` VALUES (5637, 2, 309);
...
INSERT INTO `tb_comment` VALUES (310, 15, NULL, 'hello', '2022-04-30 18:59:52', NULL, NULL, 0, 0);
INSERT INTO `tb_comment` VALUES (311, 15, 76, 'testtesttesttesttesttesttesttesttesttesttesttesttesttest', '2022-04-30 19:31:20', 15, 306, 0, 1);
...
INSERT INTO `tb_operation_log` VALUES (436, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"parentId\":176,\"requestMethod\":\"DELETE\",\"resourceName\":\"用户删除评论\",\"url\":\"/comment/deleteUserComment\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-30 17:42:51');
INSERT INTO `tb_operation_log` VALUES (437, '角色模块', '新增或修改', '/role/admin/saveOrUpdateRole', 'com.zzh.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":2,\"resourceIdList\":[227,243,245,234,235,310,311,307,308,309],\"roleLabel\":\"用户\",\"roleName\":\"ROLE_USER\",\"type\":2}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-30 17:43:05');
INSERT INTO `tb_operation_log` VALUES (438, '', '删除', '/comment/deleteUserComment', 'com.zzh.controller.CommentController.deleteComments', '用户删除评论', '[308]', 'DELETE', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 15, '3376753860@qq.com', '192.168.85.1', '本地局域网', '2022-04-30 17:54:47');
INSERT INTO `tb_operation_log` VALUES (439, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"parentId\":176,\"requestMethod\":\"GET\",\"resourceName\":\"查询未读消息数量\",\"url\":\"/comment/getNotReadCount\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-30 18:10:37');
INSERT INTO `tb_operation_log` VALUES (440, '角色模块', '新增或修改', '/role/admin/saveOrUpdateRole', 'com.zzh.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":2,\"resourceIdList\":[227,243,245,234,235,310,311,312,307,308,309],\"roleLabel\":\"用户\",\"roleName\":\"ROLE_USER\",\"type\":2}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-30 18:10:46');
INSERT INTO `tb_operation_log` VALUES (441, '资源模块', '新增或修改', '/resource/admin/addOrUpdate', 'com.zzh.controller.ResourceController.addOrUpdateResource', '添加或更新资源', '[{\"parentId\":176,\"requestMethod\":\"PUT\",\"resourceName\":\"已读信息\",\"url\":\"/comment/readComment/*\"}]', 'POST', '{\"msg\":\"操作成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-30 19:45:37');
INSERT INTO `tb_operation_log` VALUES (442, '角色模块', '新增或修改', '/role/admin/saveOrUpdateRole', 'com.zzh.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":2,\"resourceIdList\":[227,243,245,234,235,310,311,312,313,307,308,309],\"roleLabel\":\"用户\",\"roleName\":\"ROLE_USER\",\"type\":2}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-30 19:45:44');
...
INSERT INTO `tb_resource` VALUES (311, '用户删除评论', '/comment/deleteUserComment', 'DELETE', 176, '2022-04-30 17:42:51', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (312, '查询未读消息数量', '/comment/getNotReadCount', 'GET', 176, '2022-04-30 18:10:36', NULL, 0, 0);
INSERT INTO `tb_resource` VALUES (313, '已读信息', '/comment/readComment/*', 'PUT', 176, '2022-04-30 19:45:36', NULL, 0, 0);
...
INSERT INTO `tb_role` VALUES (2, 'ROLE_USER', '用户', '2022-03-09 21:27:27', '2022-04-30 19:45:44', 0);
...
INSERT INTO `tb_unique_view` VALUES (241, '2022-04-29 16:09:39', 1);
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$nUzL5ZZ6h808EWKeDr1Jg.qGuRPAkfCyaAjv1/9lChSsb6SK5A6wm', 1, 1, '2022-04-30 19:45:01', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
INSERT INTO `tb_user` VALUES (15, 16, '3376753860@qq.com', '$2a$10$gc9tXoYQFjRguXPo4szyf.xe9XEsW.SyuWznUMmgMXDZSdarbT3Xm', 1, 1, '2022-04-30 19:53:51', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
