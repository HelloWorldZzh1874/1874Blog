...
CREATE TABLE `con_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5564 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `con_role_resource` VALUES (5562, 2, 227);
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$nUzL5ZZ6h808EWKeDr1Jg.qGuRPAkfCyaAjv1/9lChSsb6SK5A6wm', 1, 1, '2022-04-20 20:59:01', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
INSERT INTO `tb_user` VALUES (15, 16, '3376753860@qq.com', '$2a$10$aLhuDUnucaatsZ0UIetHsOfYgnzerJWnxpDyZXz8w0fQAuqC4a91i', 1, 1, '2022-04-19 20:34:27', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
