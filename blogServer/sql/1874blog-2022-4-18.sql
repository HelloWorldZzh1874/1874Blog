...
CREATE TABLE `con_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5561 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `sys_quartz` VALUES (8, 'test', 'TestJob', 'commonJob', NULL, '0/5 * * * * ?', NULL, NULL, 0, 'admin', '2022-04-12 11:32:21', '2022-04-12 11:32:28');
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$nUzL5ZZ6h808EWKeDr1Jg.qGuRPAkfCyaAjv1/9lChSsb6SK5A6wm', 1, 1, '2022-04-18 16:54:22', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
