...
INSERT INTO `con_role_resource` VALUES (5588, 2, 227);
INSERT INTO `con_role_resource` VALUES (5589, 2, 243);
INSERT INTO `con_role_resource` VALUES (5590, 2, 245);
INSERT INTO `con_role_resource` VALUES (5591, 2, 234);
INSERT INTO `con_role_resource` VALUES (5592, 2, 235);
INSERT INTO `con_role_resource` VALUES (5593, 2, 307);
INSERT INTO `con_role_resource` VALUES (5594, 2, 308);
INSERT INTO `con_role_resource` VALUES (5595, 2, 309);
...
CREATE TABLE `tb_music`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '歌曲信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_role` VALUES (2, 'ROLE_USER', '用户', '2022-03-09 21:27:27', '2022-04-27 20:36:36', 0);
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$nUzL5ZZ6h808EWKeDr1Jg.qGuRPAkfCyaAjv1/9lChSsb6SK5A6wm', 1, 1, '2022-04-27 20:34:46', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
INSERT INTO `tb_user` VALUES (15, 16, '3376753860@qq.com', '$2a$10$gc9tXoYQFjRguXPo4szyf.xe9XEsW.SyuWznUMmgMXDZSdarbT3Xm', 1, 1, '2022-04-27 20:45:38', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
