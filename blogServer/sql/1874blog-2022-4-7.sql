...
CREATE TABLE `con_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1790 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `con_role_menu` VALUES (1763, 4, 1);
INSERT INTO `con_role_menu` VALUES (1764, 4, 2);
INSERT INTO `con_role_menu` VALUES (1765, 4, 6);
INSERT INTO `con_role_menu` VALUES (1766, 4, 7);
INSERT INTO `con_role_menu` VALUES (1767, 4, 8);
INSERT INTO `con_role_menu` VALUES (1768, 4, 9);
INSERT INTO `con_role_menu` VALUES (1769, 4, 10);
INSERT INTO `con_role_menu` VALUES (1770, 4, 3);
INSERT INTO `con_role_menu` VALUES (1771, 4, 11);
INSERT INTO `con_role_menu` VALUES (1772, 4, 12);
INSERT INTO `con_role_menu` VALUES (1773, 4, 202);
INSERT INTO `con_role_menu` VALUES (1774, 4, 13);
INSERT INTO `con_role_menu` VALUES (1775, 4, 14);
INSERT INTO `con_role_menu` VALUES (1776, 4, 201);
INSERT INTO `con_role_menu` VALUES (1777, 4, 4);
INSERT INTO `con_role_menu` VALUES (1778, 4, 16);
INSERT INTO `con_role_menu` VALUES (1779, 4, 15);
INSERT INTO `con_role_menu` VALUES (1780, 4, 17);
INSERT INTO `con_role_menu` VALUES (1781, 4, 214);
INSERT INTO `con_role_menu` VALUES (1782, 4, 18);
INSERT INTO `con_role_menu` VALUES (1783, 4, 19);
INSERT INTO `con_role_menu` VALUES (1784, 4, 20);
INSERT INTO `con_role_menu` VALUES (1785, 4, 208);
INSERT INTO `con_role_menu` VALUES (1786, 4, 209);
INSERT INTO `con_role_menu` VALUES (1787, 4, 210);
INSERT INTO `con_role_menu` VALUES (1788, 4, 211);
INSERT INTO `con_role_menu` VALUES (1789, 4, 5);
...
CREATE TABLE `con_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5408 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `con_role_resource` VALUES (5395, 4, 281);
INSERT INTO `con_role_resource` VALUES (5396, 4, 276);
INSERT INTO `con_role_resource` VALUES (5397, 4, 273);
INSERT INTO `con_role_resource` VALUES (5398, 4, 275);
INSERT INTO `con_role_resource` VALUES (5399, 4, 269);
INSERT INTO `con_role_resource` VALUES (5400, 4, 202);
INSERT INTO `con_role_resource` VALUES (5401, 4, 203);
INSERT INTO `con_role_resource` VALUES (5402, 4, 243);
INSERT INTO `con_role_resource` VALUES (5403, 4, 245);
INSERT INTO `con_role_resource` VALUES (5404, 4, 222);
INSERT INTO `con_role_resource` VALUES (5405, 4, 180);
INSERT INTO `con_role_resource` VALUES (5407, 4, 295);
...
CREATE TABLE `tb_operation_log`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 345 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_operation_log` VALUES (337, '博客信息模块', '修改', '/admin/notice', 'com.zzh.controller.BlogInfoController.updateNotice', '修改公告', '[\"公告测试\"]', 'PUT', '{\"msg\":\"成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-05 16:53:15');
INSERT INTO `tb_operation_log` VALUES (338, '菜单模块', '新增或修改', '/menu/admin/updateOrSaveMenu', 'com.zzh.controller.MenuController.updateOrSaveMenu', '更新或保存菜单', '[{\"component\":\"/about/About.vue\",\"createTime\":1611643325000,\"icon\":\"el-icon-myguanyuwo\",\"id\":18,\"isDisable\":0,\"isHidden\":0,\"name\":\"关于我\",\"orderNum\":6,\"path\":\"/about\"}]', 'POST', '{\"msg\":\"成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-07 13:33:37');
INSERT INTO `tb_operation_log` VALUES (339, '菜单模块', '新增或修改', '/menu/admin/updateOrSaveMenu', 'com.zzh.controller.MenuController.updateOrSaveMenu', '更新或保存菜单', '[{\"component\":\"/systemInfo/SysInfo.vue\",\"icon\":\"el-icon-myguanyuwo\",\"isHidden\":0,\"name\":\"系统信息\",\"orderNum\":4,\"parentId\":4,\"path\":\"/sysInfo\"}]', 'POST', '{\"msg\":\"成功!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-07 13:34:34');
INSERT INTO `tb_operation_log` VALUES (340, '菜单模块', '新增或修改', '/menu/admin/updateOrSaveMenu', 'com.zzh.controller.MenuController.updateOrSaveMenu', '更新或保存菜单', '[{\"component\":\"/about/About.vue\",\"createTime\":1611643325000,\"icon\":\"el-icon-myfabiaowenzhang\",\"id\":18,\"isDisable\":0,\"isHidden\":0,\"name\":\"关于我\",\"orderNum\":6,\"path\":\"/about\"}]', 'POST', '{\"msg\":\"修改成功！请退出后诚信登录!\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-07 13:48:56');
INSERT INTO `tb_operation_log` VALUES (341, '角色模块', '新增或修改', '/role/admin/saveOrUpdateRole', 'com.zzh.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":4,\"menuIdList\":[1,2,6,7,8,9,10,3,11,12,202,13,14,201,4,16,15,17,214,18,19,20,208,209,210,211,5],\"roleLabel\":\"超级管理员\",\"roleName\":\"ROLE_ROOT\",\"type\":1}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-07 13:50:14');
INSERT INTO `tb_operation_log` VALUES (342, '角色模块', '新增或修改', '/role/admin/saveOrUpdateRole', 'com.zzh.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":4,\"menuIdList\":[1,2,6,7,8,9,10,3,11,12,202,13,14,201,16,15,17,214,19,20,208,209,210,211,5],\"roleLabel\":\"超级管理员\",\"roleName\":\"ROLE_ROOT\",\"type\":1}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-07 13:50:40');
INSERT INTO `tb_operation_log` VALUES (343, '角色模块', '新增或修改', '/role/admin/saveOrUpdateRole', 'com.zzh.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":4,\"menuIdList\":[1,2,6,7,8,9,10,3,11,12,202,13,14,201,16,15,17,18,19,20,208,209,210,211,5],\"roleLabel\":\"超级管理员\",\"roleName\":\"ROLE_ROOT\",\"type\":1}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-07 13:50:52');
INSERT INTO `tb_operation_log` VALUES (344, '角色模块', '新增或修改', '/role/admin/saveOrUpdateRole', 'com.zzh.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":4,\"menuIdList\":[1,2,6,7,8,9,10,3,11,12,202,13,14,201,4,16,15,17,214,18,19,20,208,209,210,211,5],\"roleLabel\":\"超级管理员\",\"roleName\":\"ROLE_ROOT\",\"type\":1}]', 'POST', '{\"msg\":\"操作成功\",\"code\":\"200\"}', 11, 'admin', '192.168.85.1', '本地局域网', '2022-04-07 13:51:10');
...
INSERT INTO `tb_resource` VALUES (296, '获取系统信息', '/sys', NULL, NULL, NULL, NULL, 0, 0);
...
INSERT INTO `tb_role` VALUES (4, 'ROLE_ROOT', '超级管理员', '2022-03-09 21:27:27', '2022-04-07 13:51:10', 0);
...
-- ----------------------------
INSERT INTO `tb_singer` VALUES (22, 'eason', 1, '/img/singerImg/1649083335107get a life.jpg', '2022-04-04 00:00:00', 'xg', 'sss');
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$nUzL5ZZ6h808EWKeDr1Jg.qGuRPAkfCyaAjv1/9lChSsb6SK5A6wm', 1, 1, '2022-04-07 14:53:01', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
