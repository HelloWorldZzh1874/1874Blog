...
INSERT INTO `con_role_resource` VALUES (5570, 2, 227);
INSERT INTO `con_role_resource` VALUES (5571, 2, 243);
INSERT INTO `con_role_resource` VALUES (5572, 2, 245);
INSERT INTO `con_role_resource` VALUES (5573, 2, 234);
INSERT INTO `con_role_resource` VALUES (5574, 2, 235);
...
CREATE TABLE `tb_message`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3457 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_role` VALUES (2, 'ROLE_USER', '用户', '2022-03-09 21:27:27', '2022-04-24 21:50:09', 0);
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (11, 12, 'admin', '$2a$10$nUzL5ZZ6h808EWKeDr1Jg.qGuRPAkfCyaAjv1/9lChSsb6SK5A6wm', 1, 1, '2022-04-24 21:49:18', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
INSERT INTO `tb_user` VALUES (15, 16, '3376753860@qq.com', '$2a$10$aLhuDUnucaatsZ0UIetHsOfYgnzerJWnxpDyZXz8w0fQAuqC4a91i', 1, 1, '2022-04-24 22:37:42', '192.168.85.1', '本地局域网', 'Chrome 10', 'Windows 10');
