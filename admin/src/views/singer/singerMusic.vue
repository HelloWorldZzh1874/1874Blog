...
import { listMusicBySinger, deleteMusic, updateInfo } from "../../api/index";
...
export default {
  ...
  methods: {
    ...
    listMusics() {
      ...
      parma.append("current", this.current);
      parma.append("size", this.size);
      parma.append("singerId", this.singerId);
      parma.append("keywords", this.keywords === null ? "" : this.keywords);
      listMusicBySinger(parma).then(res => {
