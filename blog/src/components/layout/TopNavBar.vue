  ...
  <v-app-bar app :class="navClass" hide-on-scroll flat height="60">
    ...
    <div class="d-md-none nav-mobile-container">
      <div style="font-size: 18px; font-weight: bold">
        <router-link to="/"> 1874</router-link>
      </div>
    ...
    <div class="d-md-block d-none nav-container">
      ...
      <div class="float-right nav-title">
        ...
        <div class="user-btn">
          ...
          <template v-else>
            <el-badge :is-dot="this.$store.state.commentCount > 0" class="item">
              <img
                class="user-avatar"
              ...
              <ul class="user-submenu">
                ...
                <li>
                  <el-badge
                    :value="this.$store.state.commentCount"
                    :max="99"
                    :hidden="this.$store.state.commentCount < 1"
                  >
                    <router-link to="/comment">
                      <i class="iconfont iconyueliang" /> 查看回复
                    </router-link>
                  </el-badge>
                </li>
                <li>
