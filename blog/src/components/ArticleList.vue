...
<style scoped>
.tag-banner {
  background: url(https://1874centos-1304996288.cos.ap-chongqing.myqcloud.com/PageImg/tag.jpg)
    center center / cover no-repeat;
  background-color: #49b1f5;
}
.category-banner {
  background: url(https://1874centos-1304996288.cos.ap-chongqing.myqcloud.com/PageImg/cata.jpg)
    center center / cover no-repeat;
  background-color: #49b1f5;
}
