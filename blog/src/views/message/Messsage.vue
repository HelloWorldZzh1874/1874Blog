...
<script>
import { getMessageList, addMessage } from "../../api/index";
  ...
  methods: {
    addToList() {
      ...
      const userAvatar = this.$store.state.avatar
        ...
        : "https://1874centos-1304996288.cos.ap-chongqing.myqcloud.com/AvatarImg/catAvatar.webp";
...
.message-banner {
  ...
  right: 0;
  height: 100vh;
  background: url(https://1874centos-1304996288.cos.ap-chongqing.myqcloud.com/PageImg/fish.webp)
