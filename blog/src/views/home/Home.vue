  ...
  <div>
    ...
    <div class="home-banner">
      <div class="banner-container">
        <!-- 联系方式 -->
        <h1 class="blog-title animated zoomIn">1874BLOG</h1>
        <!-- 一言 -->
        ...
        <div class="blog-contact">
          <a
            ...
            target="_blank"
            href="http://wpa.qq.com/msgrd?v=3&uin=374368081&site=qq&menu=yes"
          />
          <a
            target="_blank"
            href="https://github.com/HelloWorldZzh1874"
            class="ml-5 mr-5 iconfont icongithub"
          />
          <a
            target="_blank"
            href="https://gitee.com/helloword20200129"
        ...
        <div class="blog-wrapper">
          <v-card class="animated zoomIn blog-card mt-5">
            <div class="author-wrapper">
              <v-avatar size="110">
                <img class="author-avatar" :src="blogInfo.avatar" alt="头像" />
              </v-avatar>
...
<script>
import { getHomeDate, getHomeArticle } from "../../api/index";
...
export default {
  ...
  methods: {
    ...
    runTime() {
      let timeold = new Date().getTime() - new Date("April 2,2022").getTime();
    ...
    infiniteHandler($state) {
      ...
      getHomeArticle(this.current).then(res => {
        if (res.data.length) {
          // 去除markdown标签
...
.home-banner {
  ...
  height: 100vh;
  background: #49b1f5
    url("https://1874centos-1304996288.cos.ap-chongqing.myqcloud.com/PageImg/background.jpg")
