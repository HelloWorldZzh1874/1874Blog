...
import { getArticleComments, getLinkList } from "../../api/index";
export default {
  components: {
    Comment
  },
  ...
  methods: {
    ...
    listComments() {
      // 初始化第一页评论
      getArticleComments(-1, 1).then(res => {
...
.link-banner {
  background: url(https://1874centos-1304996288.cos.ap-chongqing.myqcloud.com/PageImg/tree.jpg)
