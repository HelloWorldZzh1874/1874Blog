      ...
      <v-col md="3" cols="12" class="d-md-block d-none">
        <div style="position: sticky; top: 20px">
          ...
          <v-card class="right-container" style="margin-top: 20px">
            <div class="right-title">
              <i
                class="iconfont icongengxinshijian"
...
export default {
  ...
  data: function() {
    return {
      // 分享插件相关配置
      config: {
        url: "http://zzh1874.com" + this.$route.path,
  ...
  methods: {
    ...
    getArticle() {
      ...
      getArticle(articleId).then(res => {
        ...
        this.$nextTick(() => {
          ...
          // 计算阅读时间
          this.readTime = Math.round(this.wordNum / 60) + "分钟";
          // 添加代码复制功能
    ...
    listComment() {
      ...
      const articleId = arr[arr.length - 1];
      // 初始化第一页评论
      getArticleComments(articleId, 1).then(res => {
